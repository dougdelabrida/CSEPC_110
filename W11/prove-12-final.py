class CountryData:
    def __init__(self, entity, code, year, life_expectancy):
        self.entity = entity
        self.code = code
        self.year = year
...
def get_highest_life_expectancy(current_country, next_country):
    if current_country == None or next_country.life_expectancy > current_country.life_expectancy:
        return next_country
    else:
        return current_country

def get_lowest_life_expectancy(current_country, next_country):
    if current_country == None or next_country.life_expectancy < current_country.life_expectancy:
        return next_country
    else:
        return current_country
